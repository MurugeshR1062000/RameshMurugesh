...
<div> 
   ...
   <div class="row">
      <div class="col-lg-12 ">
      <h4 class="page-title page-title-center">Publish News</h4>
         <form>
            ...
            <div class="form-group">
               <label>News Images Or Videos</label>
               <div>
               ...
               <div class="row">
                  <div class="col-md-3 col-sm-3 col-4 col-lg-3 col-xl-2">
                     <div class="product-thumbnail">
                        <img src="assets/images/placeholder-thumb.jpg" class="img-thumbnail img-fluid" alt="" /> 
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <select class="select select2-selection select2-selection--single">
                     <option>Select</option>
                        <option>Viji Vaithi</option>
                        <option>Immanuvel</option>
                        <option>Saravanan</option>
                        <option>Gopi</option>
                        <option>Boopalan</option>
                     </select>
                  </div>
               </div>
            </div>
            ...
            <div class="m-t-20 text-center">
               <button class="btn btn-primary submit-btn">Publish News</button>
            </div>
         </form>
      </div>
   </div>
