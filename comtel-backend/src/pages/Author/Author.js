...
//       localStorage.setItem('Editclient',JSON.stringify(val))
//       // history.push(path )
//       history.push('/CreateAuthor1');
//    }

//    const handleDeleteclient =async(val)=>{
//       // console.log(val,_id)
//        const { data } = await API.post('/deleteclient', val);
...
//   return (
// <div>
//    {console.log("getaddclient123",getaddclient123)}
...
//          <a href="/CreateAuthor" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Client</a>
//       </div>
//    </div>
...
//                </div>
//              <h4  style={{fontSize:"22px"}}class="doctor-name text-ellipsis"><a href="/AuthorDetail">{val.Companyname}</a></h4>
...
function Author() {
   ...
   useEffect(()=>{
      console.log("hii",localStorage.getItem('counter'))
      ...
      const filter = getaddclient123.filter(getaddclient123 => {
       ...
       const filtercompany = getaddclient123.filter(getaddclient123 => {
         return getaddclient123.Companyname
       });
...
<div class="row">
   ...
   <div class="row doctor-grid">
      ...
      {currentTodos&&currentTodos.map((val,ind)=>{
         ...
         return(
            <>
            <div class="col-md-4 col-sm-4  col-lg-3">
         <div class="profile-widget" style={{height:"150px"}}>
  ...
  <span class="slider round"></span>
        ...
        <div class="dropdown-container" tabindex="-1">
          ...
          {/* {console.log("val",val)} */}
         <div onClick={()=>handleclick(val)} style={{cursor: "pointer",margin:"5px"}} >
            <i class="fa fa-pencil m-r-3"></i>  Edit</div>
            {/* <div  onClick={()=>handleDeleteclient(val)} style={{cursor: "pointer"}}><i class="fa fa-trash m-r-5"></i>Delete</div> */}
...
{/* <div class="doctor-img" > */}
  {/* <a class="avatar" href="/AuthorDetail"><img alt="" src="assets/img/doctor-thumb-03.jpg" /></a> */}
               {/* </div> */}
             <h4  style={{fontSize:"23px",fontWeight:"bold"}}>{val.Companyname}</h4>

             <h4  style={{fontSize:"18px"}}>{val.Companyaddress2}</h4>
             <h4  style={{fontSize:"18px"}}>{val.Companyaddress3}</h4>
            {/* <div class="doc-prof">{val.CompanyAddress3}</div> */}
            <div class="user-country">
             {/* <i ></i>{val.Active =="true"?"Active":"InActive"} */}
             {/* onFocus={val.Active =="true"?"Active":"InActive"} */}
             
             {/* <div>{val.Companyaddress3}</div> */}
            </div>
         </div>
      </div>
